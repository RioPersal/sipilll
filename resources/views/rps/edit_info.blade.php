...
@section('judul','Edit Data Informasi RPS')
@section('content')
<div class="card">
    <form class="form-horizontal" form action="{{url ('/rps/{matkul:id}/edit_info_rps')}}" method="POST">
        <div class="card-body">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control @error('deskripsi') is-invalid  @enderror" name="deskripsi" value="{{ old('deskripsi', $info->deskripsi) }}" placeholder="Deskripsi singkat Mata Kuliah">
                    @error('deskripsi')
            ...
            <div id="inputContainer">
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Bahan Kajian {{ $loop->iteration }}</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('kajian') is-invalid  @enderror" name="kajian[]" value="{{ old('kajian', $item) }}" placeholder="Bahan Kajian 1">
                        @error('kajian')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div id="inputContainer2">
                @foreach ($value_refrensi as $item2)
                    <div class="form-group row mt-3">
                        <label class="col-sm-2 col-form-label">Refrensi {{ $loop->iteration }}</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('refrensi') is-invalid  @enderror" name="refrensi[]" value="{{ old('refrensi', $item2) }}" placeholder="Refrensi 1">
                            @error('refrensi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
